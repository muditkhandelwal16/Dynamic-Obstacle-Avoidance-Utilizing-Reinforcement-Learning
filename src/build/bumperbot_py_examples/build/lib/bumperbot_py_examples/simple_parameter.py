...
# ros2 run bumperbot_py_examples simple_parameter --ros-args -p simple_int_param:=30 here --ros-args ... is used to update the declared parameter value
# ros2 param get /simple_parameter simple_int_param  here /simple_int_param is the parameter name and we can use this command to get the param value, replace get with set to override the param
